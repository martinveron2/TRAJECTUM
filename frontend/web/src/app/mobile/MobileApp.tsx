...
import type { NumericField, Vehicle, MotorConfig } from '../../shared/types/engineering';
import { initialVehicle, initialMotorConfigs, motorAverageThrust } from '../../shared/state/engineeringDefaults';
